...
\begin{enumerate}[label=P\arabic*.]
  ...
  \item \textbf{Canonical challenge maturity.} V1 finalisation maturity is a canonical relative-block CKB \texttt{since} condition, not a raw integer threshold.
...
If a factory action cannot prove non-interference, then a conservative first implementation should require signatures from all factory participants. If non-interference is proven, the signing set may be reduced to the affected participants only when the touched rights also satisfy participant authorisation, local validity, and value conservation.
\end{proposition}
...
\begin{enumerate}[label=O\arabic*.]
  ...
  \item Typed reduced exits require complete binding of asset type, amount, child vault, settlement descriptor, and factory-vault change before they can be treated as active V1 acceptance paths.
\end{enumerate}
