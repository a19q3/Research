...
\begin{enumerate}[label=O\arabic*.]
  ...
  \item Typed reduced exits are admissible only when asset type, amount, child vault, settlement descriptor, and factory-vault change are completely bound; broader typed-asset compatibility remains future work.
\end{enumerate}
